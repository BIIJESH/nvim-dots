  ...
  },
  {
    ...
    config = function(_, opts)
      require("fzf-lua").setup({
        ...
        grep = {
          rg_opts =
"--hidden --column --line-number --no-heading --color=always --smart-case -g '!node_modules/*' -g '!venv/*' -g '!.vite/*' "
        },
    ...
    keys = {
      ...
      { "<leader>fd", "<cmd>FzfLua diagonostics_document<CR>", desc = "Diagonostics Document" },
      {
        "<leader>ca",
